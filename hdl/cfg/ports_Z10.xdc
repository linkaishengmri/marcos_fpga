...
set_property PACKAGE_PIN M14 [get_ports rx_gate_o]

set_property IOSTANDARD LVCMOS33 [get_ports trig_i]
set_property PACKAGE_PIN H16 [get_ports trig_i]
...
set_property PACKAGE_PIN L16 [get_ports gain_si_o]
set_property PACKAGE_PIN K17 [get_ports gain_clk_o]
set_property PACKAGE_PIN L14 [get_ports gain_le_o]
set_property PACKAGE_PIN G17 [get_ports gain_sel_o]
...
set_property PACKAGE_PIN J18 [get_ports {trig_p_o}]
