...
set_property PACKAGE_PIN N18 [get_ports trig_waiting_o]
set_property IOSTANDARD LVCMOS18 [get_ports run_o]
set_property PACKAGE_PIN P19 [get_ports run_o]
...
set_property PACKAGE_PIN G17 [get_ports {exp_n_tri_io[0]}]
# set_property PACKAGE_PIN H16 [get_ports {exp_p_tri_io[1]}]
set_property PACKAGE_PIN H16 [get_ports {exp_n_tri_io[1]}]
# set_property PACKAGE_PIN J18 [get_ports {exp_p_tri_io[2]}]
set_property PACKAGE_PIN J18 [get_ports {exp_n_tri_io[2]}]
# set_property PACKAGE_PIN K17 [get_ports {exp_p_tri_io[3]}]
set_property PACKAGE_PIN K17 [get_ports {exp_n_tri_io[3]}]
# set_property PACKAGE_PIN L14 [get_ports {exp_p_tri_io[4]}]
set_property PACKAGE_PIN L14 [get_ports {exp_n_tri_io[4]}]
# set_property PACKAGE_PIN L16 [get_ports {exp_p_tri_io[5]}]
set_property PACKAGE_PIN L16 [get_ports {exp_n_tri_io[5]}]
# set_property PACKAGE_PIN K16 [get_ports {exp_p_tri_io[6]}]
set_property PACKAGE_PIN K16 [get_ports {exp_n_tri_io[6]}]
set_property PACKAGE_PIN M14 [get_ports {exp_n_tri_io[7]}]
...
set_property PACKAGE_PIN H18 [get_ports rx_gate_o]

# Trigger input, DIO8_N (RP-122 only)
set_property IOSTANDARD LVCMOS33 [get_ports trig_i]
set_property PACKAGE_PIN G18 [get_ports trig_i]
...
set_property IOSTANDARD LVCMOS33 [get_ports gain_sel_o]
...
set_property SLEW SLOW [get_ports gain_sel_o]
...
set_property DRIVE 4 [get_ports gain_sel_o]
...
set_property PULLTYPE PULLUP [get_ports gain_sel_o]

set_property PACKAGE_PIN L15 [get_ports gain_si_o]
set_property PACKAGE_PIN L17 [get_ports gain_clk_o]
set_property PACKAGE_PIN J16 [get_ports gain_le_o]
set_property PACKAGE_PIN M15 [get_ports gain_sel_o]
...
set_property IOSTANDARD LVCMOS33 [get_ports trig_p_o]
# set_property IOSTANDARD LVCMOS18 [get_ports trig_n_o]
set_property PACKAGE_PIN H17 [get_ports {trig_p_o}]
...
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports lo_diff_clk_p]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports lo_diff_clk_n]

set_property PACKAGE_PIN P14 [get_ports lo_diff_clk_p]
set_property PACKAGE_PIN R14 [get_ports lo_diff_clk_n]
